...
def translate_text(text, from_language, to_language):
    ...
    translation_prompt = f"Translate the following text from  to :\n"
...
with trans:
    translated_text = ''  # Initialize within the button's scope
...
with summ:
    if st.button("Summary"):
        if translated_text:  # Check if translation exists
            # Summary of Text
